...
public class ArtistCreditWs2 {
	...
	private List<NameCreditWs2> nameCredits = new ArrayList<NameCreditWs2>();

	/**
	 * Minimal Constructor
	 * @param nameCredits A list of NameCreditWs2 describing the Artist Credit.
	 */
	...
	private void addNameCredit(NameCreditWs2 nameCredit) {
		...
		if (nameCredit.getNameCreditString() != null && !nameCredit.getNameCreditString().equals("")) {
			artistCreditString = artistCreditString + nameCredit.getNameCreditString();
		}
	}
