...
public abstract class EntityWs2 extends DomainsWs2 {
	...
	/**
	 * The list of aliases for this entitty (Artists, Label and Works at present time).
	 */
	...
	/**
	 * The list of tags for this entity (not for releases at present time).
	 */
	private List<TagWs2> tags = new ArrayList<TagWs2>();

	/**
	 * The rating people give to this entity (not for releases at present time).
	 */
