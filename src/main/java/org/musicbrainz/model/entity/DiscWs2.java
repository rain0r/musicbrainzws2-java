...
public class DiscWs2 extends EntityWs2 {
	...
	public boolean isTrackListEquals(List<DiscTrackWs2> otherTracks) {
		...
		if (tracks == null && otherTracks == null)
			return true;
		if (tracks == null)
			return false;
		if (otherTracks == null)
	...
	public boolean isTocEquals(String otherToc) {
		...
		if (this.getToc() == null && otherToc == null)
			return true;
	...
	public boolean isDiscIdEquals(String otherDiscId) {
		...
		if (this.getDiscId() == null && otherDiscId == null)
			return true;

		if (otherDiscId == null)
			return false;
		if (this.getDiscId() == null)
			return false;
	...
	public boolean equals(Object object) {
		...
		if (this.discId == null)
			return false;
		if (other.getDiscId() == null)
			return false;
		if (!this.discId.equals(other.getDiscId()))
			return false;
