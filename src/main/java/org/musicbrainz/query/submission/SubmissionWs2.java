...
public abstract class SubmissionWs2 extends DomainsWs2 {
	...
	public void addEntity(EntityWs2 entity) throws SubmissionException {
		...
		if (!entityType.equals(LABEL) && !entityType.equals(ARTIST) && !entityType.equals(RELEASEGROUP)
				&& !entityType.equals(RECORDING) && !entityType.equals(WORK))
	...
	private String getEntityListType(String entityType) {
		...
		if (entityType.equals(ARTIST))
			return ARTISTLIST;
		if (entityType.equals(RELEASEGROUP))
			return RELEASEGROUPLIST;
		if (entityType.equals(RECORDING))
