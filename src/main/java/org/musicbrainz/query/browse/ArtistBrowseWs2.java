...
public class ArtistBrowseWs2 extends BrowseWs2 {
	...
	public ArtistBrowseWs2(ArtistBrowseFilterWs2 filter, ArtistIncludesWs2 include) {

		super(filter, include);
	}

	public ArtistBrowseWs2(WebService ws, ArtistBrowseFilterWs2 filter, ArtistIncludesWs2 include) {
	...
	private List<ArtistWs2> getOnePage() {
		...
		List<ArtistWs2> results = new ArrayList<ArtistWs2>(0);
