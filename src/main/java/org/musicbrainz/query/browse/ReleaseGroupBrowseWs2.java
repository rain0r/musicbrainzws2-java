...
public class ReleaseGroupBrowseWs2 extends BrowseWs2 {
	...
	public ReleaseGroupBrowseWs2(ReleaseGroupBrowseFilterWs2 filter, ReleaseGroupIncludesWs2 include) {

		super(filter, include);
	}

	public ReleaseGroupBrowseWs2(WebService ws, ReleaseGroupBrowseFilterWs2 filter, ReleaseGroupIncludesWs2 include) {
	...
	private List<ReleaseGroupWs2> getOnePage() {
		...
		List<ReleaseGroupWs2> results = new ArrayList<ReleaseGroupWs2>(0);
