...
public class LabelBrowseWs2 extends BrowseWs2 {
	...
	public LabelBrowseWs2(LabelBrowseFilterWs2 filter, LabelIncludesWs2 include) {

		super(filter, include);
	}

	public LabelBrowseWs2(WebService ws, LabelBrowseFilterWs2 filter, LabelIncludesWs2 include) {
	...
	private List<LabelWs2> getOnePage() {
		...
		List<LabelWs2> results = new ArrayList<LabelWs2>(0);
