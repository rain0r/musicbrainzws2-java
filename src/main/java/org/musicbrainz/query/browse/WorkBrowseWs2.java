...
public class WorkBrowseWs2 extends BrowseWs2 {
	...
	public WorkBrowseWs2(WorkBrowseFilterWs2 filter, WorkIncludesWs2 include) {

		super(filter, include);
	}

	public WorkBrowseWs2(WebService ws, WorkBrowseFilterWs2 filter, WorkIncludesWs2 include) {
	...
	private List<WorkWs2> getOnePage() {
		...
		List<WorkWs2> results = new ArrayList<WorkWs2>(0);
