...
public class RecordingBrowseWs2 extends BrowseWs2 {
	...
	public RecordingBrowseWs2(RecordingBrowseFilterWs2 filter, RecordingIncludesWs2 include) {

		super(filter, include);
	}

	public RecordingBrowseWs2(WebService ws, RecordingBrowseFilterWs2 filter, RecordingIncludesWs2 include) {
	...
	private List<RecordingWs2> getOnePage() {
		...
		List<RecordingWs2> results = new ArrayList<RecordingWs2>(0);
