...
public class ReleaseBrowseWs2 extends BrowseWs2 {
	...
	public ReleaseBrowseWs2(ReleaseBrowseFilterWs2 filter, ReleaseIncludesWs2 include) {

		super(filter, include);
	}

	public ReleaseBrowseWs2(WebService ws, ReleaseBrowseFilterWs2 filter, ReleaseIncludesWs2 include) {
	...
	private List<ReleaseWs2> getOnePage() {
		...
		List<ReleaseWs2> results = new ArrayList<ReleaseWs2>(0);
