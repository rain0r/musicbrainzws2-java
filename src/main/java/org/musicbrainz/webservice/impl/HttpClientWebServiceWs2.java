...
public class HttpClientWebServiceWs2 extends DefaultWebServiceWs2 {
	 ...
	 */
	public HttpClientWebServiceWs2(String applicationName, String applicationVersion, String applicationContact) {
	...
	private Metadata executeMethod(HttpClient httpClient, HttpUriRequest method)
	...
	private String buildMessage(HttpResponse response, String status) {
		...
		try {
			...
			try {
				...
				Logger.getLogger(HttpClientWebServiceWs2.class.getName()).log(Level.SEVERE,
