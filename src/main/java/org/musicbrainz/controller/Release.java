...
public class Release extends Controller {
	 ...
	 */
	public Release(String applicationName, String applicationVersion, String applicationContact) {
	...
	private boolean needsLookUp(ReleaseIncludesWs2 inc) {
		...
		return (getRelease() == null || super.needsLookUp(inc) || inc.isLabel() || inc.isReleaseGroups()
