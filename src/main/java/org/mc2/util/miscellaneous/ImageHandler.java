...
public class ImageHandler {
	...
	public static BufferedImage resizeProps(BufferedImage img, int width, int height) {
	...
	private static BufferedImage resizeImageProp(BufferedImage originalImage, int width, int height) {
	...
	public static void writeImageToFile(BufferedImage image, java.io.File file, String format) throws IOException {
